...
public class Test {
    ...
    final static Map<String, String> SUPPORTED_CIPHER_MODES = Map.of(
            // According to BC:
            // FIPS is largely ambivalent towards padding mechanisms, so all modes are
            // available in both approved-mode and general operation
    ...
    private static void testMessageDigestsAndCiphers() {
        ...
        for (String entry : SUPPORTED_DIGESTS) {
            try {
                ...
                System.err.println(entry
                        + " is not available. Validation failed. See page 37 of https://downloads.bouncycastle.org/fips-java/docs/BC-FJA-UserGuide-2.0.0.pdf");
                System.out.println("Details: ");
                e.printStackTrace();
                System.exit(1);
            }
        ...
        for (String entry : UNSUPPORTED_DIGESTS) {
            try {
                ...
                System.err.println(entry
                        + " is available. Validation failed. See page 37 of https://downloads.bouncycastle.org/fips-java/docs/BC-FJA-UserGuide-2.0.0.pdf");
                System.exit(1);
            } catch (NoSuchAlgorithmException | NoSuchProviderException e) {
                // expected
