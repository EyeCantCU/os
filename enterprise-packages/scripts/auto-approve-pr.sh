...
get_prs() {
  gh search prs --repo chainguard-dev/enterprise-packages --app "octo-sts" --label "auto-approver-bot/approve" --limit=150 --review none --state open --json number --jq '.[].number'
}
