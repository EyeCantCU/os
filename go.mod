...
require (
	...
	github.com/wolfi-dev/wolfictl v0.38.18
...
require (
	...
	github.com/GoogleCloudPlatform/cloud-image-tests v0.0.0-20251016062436-4106eca52691 // indirect
