...
Sometimes a package needs to be withdrawn because it has been
...
2. Run the ["Withdraw packages"](https://github.com/chainguard-dev/extra-packages/actions/workflows/withdraw-packages.yaml) workflow on GitHub.
